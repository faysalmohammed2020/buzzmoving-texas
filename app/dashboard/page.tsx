    ...
    <div className="p-6 bg-gray-100 min-h-screen font-sans">
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white shadow-md rounded-xl p-4">
          ...
          <h3 className="text-xl mt-2 ml-2 font-bold">301</h3>
        </div>

        {/* Plan Upgrade */}
        <div className="bg-white shadow-md rounded-xl py-4 px-8 flex flex-col justify-between">
          <div className="flex justify-between">
            <h3 className="text-gray-700 font-bold text-lg">Likes:</h3>
            <h2 className="text-lg font-bold">123,434</h2>
          </div>

          <div className="flex justify-between">
            <h3 className="text-gray-700 font-bold text-lg">Comments:</h3>
            <h2 className="text-lg font-bold">123,434</h2>
          </div>

          <div className="flex justify-between">
            <h3 className="text-gray-700 font-bold text-lg">Share:</h3>
            <h2 className="text-lg font-bold">123,434</h2>
          </div>
        </div>
      </section>
                ...
                {blogs.map((blog, index) => (
                  ...
                  >
                    ...
                    <div className="flex gap-2">
                      <button className="text-blue-500 text-sm font-bold">Edit</button>
