  ...
  return (
    <>
      ...
      >
            ...
            {sidebarItems.map((item: SidebarItem) => {
              ...
              return (
                <li key={item.href}>
                  ...
                  >
                    <div className={`${active ? "text-cyan-400" : "text-slate-400 group-hover:text-cyan-300"} transition-colors`}>
                      {item.icon}
                    </div>
                    {!isCollapsed && (
                      <>
        ...
        <div className="px-3 py-4 border-t border-slate-700/50" ref={profileMenuRef}>
          <div className="relative">
            ...
            >
              <div className="flex items-center gap-3">
                <div className="relative">
                  <div className="h-10 w-10 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center text-white font-semibold shadow-lg">
                    {user?.avatar ? (
                      <img 
                        src={user.avatar} 
                        alt={user.name || "User"} 
